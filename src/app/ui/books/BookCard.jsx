    ...
    <Link href={`/store/${book.id}`}>
      <div className="flex flex-col items-center rounded-xl bg-gray-50 p-2 m-2 shadow-sm ">
        <div className="flex p-4">
          <h3 className="ml-2 text-sm font-medium text-black">{book.title}</h3>
        </div>
        ...
        <div className="flex flex-col justify-around truncate rounded-xl bg-white px-4 py-8 w-full text-xs text-black">
